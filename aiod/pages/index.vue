    ...
    <section class="bg-royal-grey">
      <div class="container py-lg-6 py-5">
        ...
        <div class="tns-carousel-wrapper tns-nav-inverse">
          <tiny-slider
            class="tns-carousel-inner ms-auto"
            :controls-container="'#tns-projects-controls'"
            :loop="true"
            :mouse-drag="true"
                ...
                <div class="portfolio-card-img">
                  ...
                  <div class="portfolio-card-body">
                    <h3 class="portfolio-card-title text-white">
                      Boards, Governance and Effectiveness
                    </h3>
                    <div class="fs-sm text-white">Elite Plaza</div>
        ...
        <h4
          class="h3 d-flex flex-md-row flex-column align-items-center justify-content-center pt-sm-0 pt-4 text-center text-white"
        >
          Explore all our events
          <NuxtLink
            to="/eventspage"
            class="btn btn-lg btn-primary mt-md-0 mt-sm-4 mt-3 ms-md-5 text-uppercase"
...
/* @media only screen and (min-width: 800px) {
    ...
    animation: reveal .5s forwards var(--delay) !important;
  }
