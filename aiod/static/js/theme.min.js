...
!(function () {
  ...
  null != (r = document.querySelector('.navbar-sticky')) &&
        ...
        for (var e = 0; e < l.length; e++)
          !(function (e) {
            ...
            l[e].addEventListener('submit', function (e) {
              e && e.preventDefault(), '' === a.value && s(this, t, n, r, o)
            })
          })(e)
          ...
          var n = void 0,
            a =
              (0 < e[r].dataset.progressRadial.length &&
                (n = JSON.parse(e[r].dataset.progressRadial)),
              _objectSpread(_objectSpread({}, t), n)),
            a = new ProgressBar.Circle(e[r], a),
            n = null != n ? n.progress : 0.75
          a.animate(n)
        }
    })(),
    (function () {
    ...
    (function () {
      for (
        var t = document.querySelectorAll('.filter'),
          e = function (e) {
    ...
    (function () {
      for (
        var a = document.querySelectorAll('.range-slider'), e = 0;
        e < a.length;
        e++
      )
        !(function (e) {
